...
// Taxa List
export const TOGGLE_TAXA_LIST_COLLAPSE = 'TOGGLE_TAXA_LIST_COLLAPSE';
...
export const TOGGLE_HIGHLIGHT_TREES_DISTRIBUTION = 'TOGGLE_HIGHLIGHT_TREES_DISTRIBUTION';


// Global Toolkit
export const TOGGLE_GLOBAL_TOOLKIT = 'TOGGLE_GLOBAL_TOOLKIT';
export const CLEAR_SELECTED_TREES = 'CLEAR_SELECTED_TREES';
export const MOVE_GLOBAL_TOOLKIT = 'MOVE_GLOBAL_TOOLKIT';
export const MOVE_TOOLKIT_START = 'MOVE_TOOLKIT_START';
export const MOVE_TOOLKIT_END = 'MOVE_TOOLKIT_END';
